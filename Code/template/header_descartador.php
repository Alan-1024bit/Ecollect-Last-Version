            ...
            <div class="collapse navbar-collapse Cabin" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active mr-3">
                        <a class="nav-link text-secondary" href="descartador_solicitacoes.php">Solicitações</a>
                    </li>

                    <li class="nav-item mr-3">
                        <a class="nav-link text-secondary" href="descartador_agendadas.php">Agendadas</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <button class="dropdown-toggle nav-link text-secondary"
                            type="button"
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="../src/geral_ajustes.php?perfil=1">Configurações</a>
